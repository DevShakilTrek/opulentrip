    ...
    <div>
      ...
      <div className='flex my-8 gap-4'>
        ...
        <div className='flex flex-col sm:ml-4 font-medium'>
          ...
          <p className='text-neutral-600 tex-base'>{dashboardData.totalBookings}</p>
        </div>
        ...
        <div className='flex flex-col sm:ml-4 font-medium'>
          ...
          <p className='text-neutral-600 tex-base'>Ksh {dashboardData.totalRevenue}</p>
        </div>
      ...
      {/* Recent Bookings  */}
      <h2 className='font-medium text-xl text-blue-950/70 mb-5'>Recent Bookings</h2>
          ...
          <tbody className='text-sm'>
            {dashboardData.bookings.map((item, index) => (
              <tr key={index}>
                ...
                <td className='px-4 py-3 text-gray-700 border-t border-gray-300 text-center'>Ksh {item.totalPrice}</td>
                <td className='px-4 py-3 text-gray-700 border-t border-gray-300 flex'>
                  <button className={`py-1 px-3 text-xs rounded-full mx-auto ${item.isPaid ? "bg-green-200 text-green-600" : "bg-amber-200 text-amber-600"}`}>
